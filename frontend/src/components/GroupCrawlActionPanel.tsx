...
import type { GroupActionPanelProps } from '@/components/GroupActionPanel';

interface GroupCrawlActionPanelProps {
  actions: GroupActionPanelProps['actions'];
  crawl: GroupActionPanelProps['crawl'];
  downloadLoading: GroupActionPanelProps['download']['loading'];
  hasTopics: boolean;
}
...
export default function GroupCrawlActionPanel({
  actions,
  crawl,
  downloadLoading,
  hasTopics,
}: GroupCrawlActionPanelProps) {
      ...
      <div className="space-y-4">
        ...
        {hasTopics && (
          <div className="space-y-2 border-t border-red-100 pt-3">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button size="sm" variant="destructive" className="w-full h-7 text-xs" disabled={!!crawl.loading || !!downloadLoading}>
                  删除所有话题数据
                </Button>
              </AlertDialogTrigger>
              <AlertDialogContent>
