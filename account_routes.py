...
async def list_accounts():
    """获取所有账号列表"""
    try:
        sql_mgr = _get_main_attr("get_accounts_sql_manager")()
...
async def create_account(request: AccountCreateRequest):
    ...
    try:
        ...
        _get_main_attr("clear_account_detect_cache")()
...
async def get_group_account(group_id: str):
    try:
        summary = _get_main_attr("get_account_summary_for_group_auto")(group_id)
...
async def get_account_self(account_id: str):
    ...
    try:
        db = _get_main_attr("get_account_info_db")()
